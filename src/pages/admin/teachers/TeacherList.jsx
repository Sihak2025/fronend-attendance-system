    ...
    <div className='min-h-screen bg-slate-50 flex'>
      ...
      <main className='flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto pt-20 lg:pt-8 lg:ml-64 max-w-7xl mx-auto'>
        <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4'>
          ...
          <Link
            to='/teacher/teachercreate'
            className='inline-flex items-center justify-center bg-blue-600 text-white px-5 py-2.5 rounded-xl font-medium shadow-sm hover:bg-blue-700 transition-all duration-200 text-xs sm:text-sm'>
            <svg
                  ...
                  filteredTeachers.map((teacher) => (
                    <tr
                      ...
                      <td className='px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-3'>
                        <Link
                          to={`/teacher/teacherupdate/${teacher.id}`}
                          className='text-blue-600 hover:text-blue-900 font-medium transition-colors inline-block'>
                          Edit
                        </Link>
                        <button
