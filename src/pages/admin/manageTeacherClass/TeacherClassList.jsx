...
const TeacherClassList = () => {
  ...
  return (
    <div className='min-h-screen bg-gray-50 flex'>
      <AdminSidebar />
      <div className='flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto pt-20 lg:pt-8 lg:ml-64 max-w-7xl mx-auto'>
        <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4'>
          ...
          <Link
            to='/teacherclasslist/teacherclasscreate'
            className='w-full sm:w-auto'>
            <button className='w-full sm:w-auto flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-xl text-xs font-semibold shadow-md transition-all'>
              <Plus size={16} />
                    ...
                    <td className='px-4 sm:px-6 py-4 whitespace-nowrap text-right text-sm font-medium'>
                      <div className='flex items-center justify-end gap-2'>
                        <button
                          onClick={() =>
                            navigate(
                              `/teacherclass/teacherclassupdate/${item.id}`,
                            )
                          }
